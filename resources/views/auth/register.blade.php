...
<body>
    ...
    <section class="auth-section">
        ...
        <div class="auth-card">
            ...
            <p>Aizpildi informāciju, lai sāktu</p>
            <form method="POST" action="{{ route('register.store') }}">
                @csrf
                <div class="form-field">
                    <label for="name">Vārds, Uzvārds</label>
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="piem., Anna Ozoliņa">
                    @error('name')
                ...
                <div class="form-grid">
                    <div class="form-field">
                        ...
                        <input type="password" id="password" name="password" required placeholder="Vismaz 8 simboli">
                        @error('password')
                            <small style="color:#c53030; display:block; margin-top:0.3rem;">{{ $message }}</small>
                        @enderror
                    </div>
