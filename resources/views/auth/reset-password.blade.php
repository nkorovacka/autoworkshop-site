...
<head>
    ...
    <title>Atjaunot paroli - Auto Detailing Workshop</title>
</head>
<body>
...
<main>
    ...
    <section class="auth-header">
        ...
        <p>Ievadi jauno paroli un apstiprini to, lai pabeigtu atiestatīšanu.</p>
    </section>
    ...
    <!-- Paroles atjaunošanas forma ar tokenu -->
    <section class="auth-card">
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <button type="submit">Saglabāt jauno paroli</button>
        </form>
